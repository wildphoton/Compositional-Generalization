...
def init_optimizer(optimizer, params, lr=0.01, weight_decay=0.0, **kwargs):
    ...
    if optimizer == 'adam':
        ...
        optimizer = optim.Adamax(params, lr=lr, weight_decay=weight_decay, **kwargs)
    elif optimizer == 'rmsprop':
        optimizer = optim.RMSprop(params, lr=lr,
                                  weight_decay=weight_decay, **kwargs)
    elif optimizer == 'sgd':
        optimizer = optim.SGD(params, lr=lr,
                              weight_decay=weight_decay, **kwargs)  # 0.01
