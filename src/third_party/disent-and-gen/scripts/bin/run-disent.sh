...
python -m experiments.disent with dataset.dsprites dataset.condition=recomb2element \
                                 ...
                                 model.burgess_v2  \
                                 training.loss.params.beta=0 \
                                 training.loss.params.reconstruction_loss='bce'

python -m experiments.disent with dataset.dsprites dataset.condition=recomb2element \
                                 dataset.variant=leave1out \
                                 model.burgess_v2  \
                                 training.loss.params.beta=0 \
                                 training.loss.params.reconstruction_loss='mse'
...
#                                 dataset.variant=leave1out \
#                                 model.burgess_v2  \
#                                 training.loss.params.beta=1 \
#                                 training.loss.params.reconstruction_loss='mse'
#
#python -m experiments.disent with dataset.dsprites dataset.condition=recomb2element \
#                                 dataset.variant=leave1out \
#                                 model.burgess_v2  \
#                                 training.loss.params.beta=2 \
#                                 training.loss.params.reconstruction_loss='mse'
#
#python -m experiments.disent with dataset.dsprites dataset.condition=recomb2element \
#                                 dataset.variant=leave1out \
#                                 model.burgess_v2  \
#                                 training.loss.params.beta=4 \
#                                 training.loss.params.reconstruction_loss='mse'
#
#python -m experiments.disent with dataset.dsprites dataset.condition=recomb2element \
#                                 dataset.variant=leave1out \
