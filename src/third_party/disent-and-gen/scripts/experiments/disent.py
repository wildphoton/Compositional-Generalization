...
# Set up experiment
ex = Experiment(name='disent', ingredients=[dataset, model, training], save_git_info=False)

# Observers
ex.observers.append(FileStorageObserver.create('../data/sims/disent/dsprites'))
